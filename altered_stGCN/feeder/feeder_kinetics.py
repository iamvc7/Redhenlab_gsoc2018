...
class Feeder_kinetics(torch.utils.data.Dataset):
    ...
    def load_data(self):
        # load file list
            ...
            #print("No such file '{}'".format(self.data_path), file=sys.stderr)
    ...
    def __getitem__(self, index):
        ...
        for frame_info in video_info['data']:
            ...
            lbl_index.append(frame_info['label_index'])
            lbl.append(frame_info['label'])
