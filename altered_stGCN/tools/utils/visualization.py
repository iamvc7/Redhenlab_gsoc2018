...
def stgcn_visualize(pose,
    ...
    for t in range(T):
        ...
        for m in range(M):
            ...
            cv2.putText(text,'prediction: ' + body_label, (10,500),
        ...
        skeleton_result = blurred_mask.astype(float) * 0.000075
        ...
        rgb_result = blurred_mask.astype(float) * 0.00075
        ...
        #cv2.putText(skeleton_result, 'prediction', *params)
        cv2.putText(rgb_result, 'pose mask', *params)
